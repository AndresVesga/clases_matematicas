...
**Problema.** Escribe en términos de \(i\): a) \(\sqrt{-25}\) b) \(\sqrt{-1}\) c) \(\sqrt{-8}\)
...
1. Escribe en términos de \(i\): a) \(\sqrt{-4}\) b) \(\sqrt{-36}\) c) \(\sqrt{-100}\) d) \(\sqrt{-1}\) e) \(\sqrt{-81}\)
2. Calcula: a) \(i^{2}\) b) \(i^{3}\) c) \(i^{4}\) d) \(i^{5}\)
3. Identifica la parte real y la parte imaginaria: a) \(3+5i\) b) \(-2+i\) c) \(7\) d) \(-4i\) e) \(0,5-2,5i\)
4. Escribe **verdadero** o **falso** y corrige lo falso: a) Todo número real es también complejo. b) \(i^{2}=1\). c) 5 no es un número complejo. d) \(\sqrt{-9}=-3\). e) El conjugado de \(2+3i\) es \(2-3i\).
5. Escribe el **conjugado** y el **opuesto** de: a) \(4+7i\) b) \(-3+2i\) c) \(6i\) d) \(-5\)

**Aplicación**

6. Escribe en términos de \(i\), simplificando la raíz: a) \(\sqrt{-8}\) b) \(\sqrt{-18}\) c) \(\sqrt{-50}\) d) \(\sqrt{-12}\)
7. Calcula usando el truco del residuo: a) \(i^{7}\) b) \(i^{12}\) c) \(i^{22}\) d) \(i^{45}\) e) \(i^{100}\)
...
10. Resuelve y escribe las dos soluciones: a) \(x^{2}=-9\) b) \(x^{2}=-49\) c) \(x^{2}+4=0\) d) \(x^{2}+20=0\)
