...
4. Multiplica: a) \((1+i)(1-i)\) b) \((2+3i)(2-3i)\) c) \((1+i)^{2}\) d) \(i(1-i)\)
...
7. Calcula: a) \((2+i)^{2}\) b) \((1-3i)^{2}\) c) \(i^{3}+i^{2}\) d) \((3-i)(3+i)\)
8. Divide usando el conjugado: a) \(\frac{-1+5i}{1+i}\) b) \(\frac{10}{1-3i}\) c) \(\frac{7-i}{2-i}\) d) \(\frac{6+2i}{i}\)
